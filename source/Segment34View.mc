...
class Segment34View extends WatchUi.WatchFace {
    ...
    hidden function setColorTheme(theme as Number) as Array<Graphics.ColorType> {
        if(theme == 0)  { return [0x000000, 0xFBCB77, 0x0D333C, 0xFFEAC4, 0xFFFFFF, 0x0E333C, 0x55AAAA, 0xFBCB77, 0xA98753, 0x00AAFF, 0xFFAA00, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 1)  { return [0x000000, 0xFFA5F9, 0x0F3B46, 0xFFD9FC, 0xFFFFFF, 0x0E333C, 0xAA55AA, 0xFFFFFF, 0x984A8A, 0xFF55AA, 0xFF55AA, 0x00FFAA, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 2)  { return [0x000000, 0x89EFD2, 0x0F2246, 0xB8EFDF, 0xFFFFFF, 0x0F2246, 0x55AAAA, 0x89EFD2, 0x5CA28F, 0x00AAFF, 0xFFAA00, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 3)  { return [0x000000, 0x96E0AC, 0x152B19, 0xC3E0CC, 0xFFFFFF, 0x152B19, 0x00AA55, 0x96E0AC, 0x5CA28F, 0x00AAFF, 0xFFC884, 0x59B9FE, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 4)  { return [0x000000, 0xFFFFFF, 0x0D333C, 0xADEFFE, 0xFFFFFF, 0x0E333C, 0x55AAAA, 0xFFFFFF, 0x1D7E99, 0xAAAAAA, 0xFFAA55, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 5)  { return [0x000000, 0xFF9161, 0x1B263D, 0xFFB494, 0xFFFFFF, 0x1B263D, 0xFFAAAA, 0xFFB383, 0xAA6E56, 0xFFFFFF, 0xFF5555, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 6)  { return [0x000000, 0xFFFFFF, 0x550000, 0xC00003, 0xFFFFFF, 0x550000, 0xFF0000, 0xFFFFFF, 0xAA0000, 0xFF0000, 0xAA0000, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 7)  { return [0x000000, 0xFFFFFF, 0x152A53, 0xAECAFF, 0xFFFFFF, 0x152A53, 0x0055AA, 0xFFFFFF, 0x0055AA, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 8)  { return [0x000000, 0xFBCB77, 0x152A53, 0xFBDDA8, 0xFFFFFF, 0x152A53, 0x0055AA, 0xFFEAC4, 0xA98753, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 9)  { return [0x000000, 0xFFFFFF, 0x7D3F01, 0xFFD6AE, 0xFFFFFF, 0x58250B, 0xFF5500, 0xFFFFFF, 0xAA5500, 0x00AAFF, 0xFFAA00, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 10) { return [0x000000, 0x3495D4, 0x191B33, 0x5FA6D4, 0xFFFFFF, 0x191B33, 0x0055AA, 0xFFFFFF, 0x0055AA, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 11) { return [0x000000, 0xFF7600, 0x333333, 0xFF9133, 0xFFFFFF, 0x333333, 0xFFAA00, 0xFFFFFF, 0x9A9A9A, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 12) { return [0x000000, 0xFFFFFF, 0x333333, 0xCBCBCB, 0xFFFFFF, 0x333333, 0xFFFFFF, 0xFFFFFF, 0x9A9A9A, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 13) { return [0xFFFFFF, 0x000000, 0xCCCCCC, 0x666666, 0x000000, 0xCCCCCC, 0x000000, 0x000000, 0x9A9A9A, 0x000000, 0xFFAA00, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 14) { return [0xFFFFFF, 0xAA0000, 0xCCCCCC, 0xAA2325, 0x000000, 0xCCCCCC, 0xAA0000, 0x000000, 0x9A9A9A, 0x000000, 0xFFAA00, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 15) { return [0xFFFFFF, 0x0000AA, 0xCCCCCC, 0x2222AA, 0x000000, 0xCCCCCC, 0x0000AA, 0x000000, 0x9A9A9A, 0x000000, 0xFFAA00, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 16) { return [0xFFFFFF, 0x00AA00, 0xCCCCCC, 0x22AA22, 0x000000, 0xCCCCCC, 0x00AA00, 0x000000, 0x9A9A9A, 0x000000, 0xFFAA00, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 17) { return [0xFFFFFF, 0xFF5500, 0xCCCCCC, 0xFF7632, 0x000000, 0xCCCCCC, 0x555555, 0x000000, 0x9A9A9A, 0x000000, 0xFF5500, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 18) { return [0x000000, 0xFF7600, 0x152B19, 0xE64322, 0x41CB41, 0x152B19, 0xFF5500, 0x41CB41, 0x5F9956, 0x41CB41, 0xFF7600, 0x59B9FE, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 19) { return [0x000000, 0x889F4A, 0x152B19, 0x919F6B, 0x55AA55, 0x152B19, 0xA8AA6C, 0x889F4A, 0x7A9A4E, 0x00FF55, 0x889F4A, 0x55AA55, 0xE3EFD2] as Array<Graphics.ColorType>; }
        if(theme == 20) { return [0x000000, 0xFF0000, 0x282828, 0xFF3236, 0xFFFFFF, 0x282828, 0xFF0000, 0xFFFFFF, 0x9A9A9A, 0x55AAFF, 0xFF5555, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 21) { return [0xFFFFFF, 0xAA00FF, 0xCCCCCC, 0xBB34FF, 0x000000, 0xCCCCCC, 0xAA00FF, 0x000000, 0x9A9A9A, 0x000000, 0xFF5500, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 22) { return [0x000000, 0xAA55AA, 0x282828, 0xAA77AA, 0xFFFFFF, 0x282828, 0xAA55AA, 0xFFFFFF, 0x9A9A9A, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 23) { return [0x000000, 0xFF960C, 0x302B24, 0xFFBF65, 0xFFDEB4, 0x302B24, 0xFFAC3F, 0xFFB759, 0x9A784D, 0xA8D6FD, 0xFDB500, 0xA8D6FD, 0xE3EFD2] as Array<Graphics.ColorType>; }
        if(theme == 30) { return parseThemeString(propColorOverride); }

        return [] as Array<Graphics.ColorType>;
    }

    (:MIP)
    hidden function setColorTheme(theme as Number) as Array<Graphics.ColorType> {
        var t = Graphics.COLOR_TRANSPARENT;
        if(theme == 0)  { return [0x000000, 0xFFFF00, 0x005555, t, 0xFFFFFF, 0x005555, 0x55AAAA, 0xFFFF00, t, 0x00AAFF, 0xFFAA00, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 1)  { return [0x000000, 0xFF55AA, 0x005555, t, 0xFFFFFF, 0x005555, 0xAA55AA, 0xFFFFFF, t, 0xFF55AA, 0xFF55AA, 0x00FFAA, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 2)  { return [0x000000, 0x00FFFF, 0x0055AA, t, 0xFFFFFF, 0x0055AA, 0x55AAAA, 0x00FFFF, t, 0x00AAFF, 0xFFAA00, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 3)  { return [0x000000, 0x00FF00, 0x005500, t, 0xFFFFFF, 0x005500, 0x00AA55, 0x00FF00, t, 0x00AAFF, 0xFFAA00, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 4)  { return [0x000000, 0xFFFFFF, 0x005555, t, 0xFFFFFF, 0x005555, 0x55AAAA, 0xFFFFFF, t, 0xAAAAAA, 0xFFAA55, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 5)  { return [0x000000, 0xFF5500, 0x5500AA, t, 0xFFFFFF, 0x5500AA, 0xFFAAAA, 0xFFAAAA, t, 0xFFFFFF, 0xFF5555, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 6)  { return [0x000000, 0xFFFFFF, 0xAA0000, t, 0xFFFFFF, 0xAA0000, 0xFF0000, 0xFFFFFF, t, 0xFF0000, 0xAA0000, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 7)  { return [0x000000, 0xFFFFFF, 0x0055AA, t, 0xFFFFFF, 0x0055AA, 0x0055AA, 0xFFFFFF, t, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 8)  { return [0x000000, 0xFFFF00, 0x0055AA, t, 0xFFFFFF, 0x0055AA, 0x0055AA, 0xFFFF00, t, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 9)  { return [0x000000, 0xFFFFFF, 0xAA5500, t, 0xFFFFFF, 0xAA5500, 0xFF5500, 0xFFFFFF, t, 0x00AAFF, 0xFFAA00, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 10) { return [0x000000, 0x0055AA, 0x000055, t, 0xFFFFFF, 0x555555, 0x0055AA, 0xFFFFFF, t, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 11) { return [0x000000, 0xFFAA00, 0x555555, t, 0xFFFFFF, 0x555555, 0xFFAA00, 0xFFFFFF, t, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 12) { return [0x000000, 0xFFFFFF, 0x555555, t, 0xFFFFFF, 0x555555, 0xFFFFFF, 0xFFFFFF, t, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 13) { return [0xFFFFFF, 0x000000, 0xAAAAAA, t, 0x000000, 0xAAAAAA, 0x000000, 0x000000, t, 0x000000, 0xFFAA00, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 14) { return [0xFFFFFF, 0xAA0000, 0xAAAAAA, t, 0x000000, 0xAAAAAA, 0xAA0000, 0x000000, t, 0x000000, 0xFFAA00, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 15) { return [0xFFFFFF, 0x0000AA, 0xAAAAAA, t, 0x000000, 0xAAAAAA, 0x0000AA, 0x000000, t, 0x000000, 0xFFAA00, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 16) { return [0xFFFFFF, 0x00AA00, 0xAAAAAA, t, 0x000000, 0xAAAAAA, 0x00AA00, 0x000000, t, 0x000000, 0xFFAA00, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 17) { return [0xFFFFFF, 0xFF5500, 0xAAAAAA, t, 0x000000, 0xAAAAAA, 0x555555, 0x000000, t, 0x000000, 0xFF5500, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 18) { return [0x000000, 0xFF5500, 0x005500, t, 0x00FF00, 0x005500, 0xFF5500, 0x00FF00, t, 0x55FF55, 0xFF5500, 0x00AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 19) { return [0x000000, 0xAAAA55, 0x005500, t, 0x00FF00, 0x005500, 0xAAAA00, 0xAAAA55, t, 0x00FF55, 0xAAAA55, 0x00FF00, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 20) { return [0x000000, 0xFF0000, 0x555555, t, 0xFFFFFF, 0x555555, 0xFF0000, 0xFFFFFF, t, 0x55AAFF, 0xFF5555, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 21) { return [0xFFFFFF, 0xAA00FF, 0xAAAAAA, t, 0x000000, 0xAAAAAA, 0xAA00FF, 0x000000, t, 0x000000, 0xFF5500, 0x55AAFF, 0x555555] as Array<Graphics.ColorType>; }
        if(theme == 22) { return [0x000000, 0xAA00FF, 0x555555, t, 0xFFFFFF, 0x555555, 0xAA00FF, 0xFFFFFF, t, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 23) { return [0x000000, 0xFFAA00, 0x555555, t, 0xFFAA55, 0x555555, 0xFFAA00, 0xFFAA55, t, 0x55AAAA, 0xFFAA00, 0x55AAAA, 0xFFFFFF] as Array<Graphics.ColorType>; }
        if(theme == 30) { return parseThemeString(propColorOverride); }
