...
class Segment34View extends WatchUi.WatchFace {
    ...
    hidden function setColorTheme(theme as Number) as Array<Graphics.ColorType> {
        ...
        if(theme == 22) { return [0x555555, 0xAA00FF, 0x555555, 0xAA00FF, 0xAA00FF, 0xFFFFFF, 0x555555, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0x000000, 0xFFFFFF, 0xFFFFFF, 0xFF0000]; } // Purple on black MIP
                          return [0x555555, 0xFFAA00, 0x555555, 0xFFAA00, 0xFFAA00, 0xFFAA55, 0x555555, 0x55AAAA, 0xFFAA00, 0x55AAAA, 0x000000, 0xFFAA55, 0xFFFFFF, 0xFF0000]; // Amber MIP
    }
    ...
    hidden function setColorTheme(theme as Number) as Array<Graphics.ColorType> {
        ...
        if(theme == 1 ) { return [0x0e333c, 0xAA55AA, 0x0f3b46, 0xffa5f9, 0xbf7bba, 0xFFFFFF, 0x8d4580, 0xFF55AA, 0xFF55AA, 0x00FFAA, 0x000000, 0xFFFFFF, 0xFFFFFF, 0xFF0000]; } // Hot pink AMOLED
        ...
        if(theme == 7 ) { return [0x152a53, 0x0055AA, 0x152a53, 0xffffff, 0xffffff, 0xffffff, 0x0055AA, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0x000000, 0xFFFFFF, 0xFFFFFF, 0xFF0000]; } // White on Blue AMOLED
        if(theme == 8 ) { return [0x152a53, 0x0055AA, 0x152a53, 0xfbcb77, 0xcca561, 0xfbcb77, 0xa98753, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0x000000, 0xFFFFFF, 0xFFFFFF, 0xFF0000]; } // Yellow on Blue AMOLED
        ...
        if(theme == 18) { return [0x152b19, 0xFF5500, 0x152b19, 0xff7600, 0xff7600, 0x41cb41, 0x51834a, 0x41cb41, 0xff7600, 0x59b9fe, 0x000000, 0x41cb41, 0xFFFFFF, 0xFF0000]; } // Green and Orange AMOLED
        ...
        if(theme == 20) { return [0x282828, 0xFF0000, 0x282828, 0xFF0000, 0xFF0000, 0xFFFFFF, 0x555555, 0x55AAFF, 0xFF5555, 0x55AAFF, 0x000000, 0xFFFFFF, 0xFFFFFF, 0xFF0000]; } // Red on Black AMOLED
        ...
        if(theme == 22) { return [0x282828, 0xAA55AA, 0x282828, 0xAA55AA, 0xAA55AA, 0xFFFFFF, 0x555555, 0x55AAFF, 0xFFAA00, 0x55AAFF, 0x000000, 0xFFFFFF, 0xFFFFFF, 0xFF0000]; } // Purple on black AMOLED
                          return [0x302b24, 0xffac3f, 0x302b24, 0xff960c, 0xb0630d, 0xffb759, 0x725939, 0xa8d6fd, 0xfdb500, 0xa8d6fd, 0x000000, 0xffdeb4, 0xe3efd2, 0xFF0000]; // Amber AMOLED
        //                       fieldBg,   fieldLbl, clockBg,  clock,    clockDim, date,     dateDim,  notif,    stress,   bodybatt, bg,       dataVal,  moon,     lowBatt
